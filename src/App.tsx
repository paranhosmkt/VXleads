...
import { Target, XCircle, CheckCircle2, UserX, Database, TrendingDown, Zap, ShieldCheck, ListOrdered, Check, HelpCircle, ChevronDown, Briefcase, DollarSign, MonitorSmartphone, WifiOff, Link, Star } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <header className="flex items-center justify-between px-6 py-5 border-b border-gray-100 max-w-7xl mx-auto w-full">
        ...
        <button className="px-5 py-2.5 text-sm font-semibold text-white bg-gray-900 rounded-lg hover:bg-gray-800 transition-colors shadow-sm cursor-pointer">
          Login / Cadastro
        </button>
      </header>
      ...
      <main className="px-6 py-24 max-w-7xl mx-auto flex flex-col lg:flex-row items-center w-full gap-12 lg:gap-8">
        <div className="flex-1 flex flex-col items-start w-full">
          <h1 className="text-5xl md:text-6xl font-extrabold text-gray-900 max-w-2xl leading-[1.15] tracking-tight mb-6 text-left">
          ...
          <button className="px-8 py-4 text-lg font-semibold text-white bg-blue-600 rounded-xl hover:bg-blue-700 transition-all shadow-lg hover:shadow-blue-600/30 cursor-pointer">
            Quero revolucionar meu estande
          </button>
        </div>
        
        <div className="flex-1 w-full max-w-2xl lg:max-w-none flex justify-center">
          <div className="w-full aspect-square bg-transparent relative overflow-hidden flex items-center justify-center pointer-events-none">
            <canvas 
              ref={canvasRef}
        ...
        <div className="max-w-7xl mx-auto w-full">
          ...
          <div className="space-y-24">
            ...
            <div className="flex flex-col md:flex-row items-center gap-12 lg:gap-20">
              ...
              <div className="flex-1 w-full relative">
                <div className="aspect-[4/3] rounded-2xl overflow-hidden shadow-2xl border border-gray-100">
                  <img src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&q=80&w=1000" alt="Dashboard de Cadastro" className="w-full h-full object-cover" />
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row-reverse items-center gap-12 lg:gap-20">
              ...
              <div className="flex-1 w-full relative">
                <div className="aspect-[4/3] rounded-2xl overflow-hidden shadow-2xl border border-gray-100">
                  <img src="https://images.unsplash.com/photo-1611162617474-5b21e879e113?auto=format&fit=crop&q=80&w=1000" alt="Seleção de Personagem" className="w-full h-full object-cover" />
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row items-center gap-12 lg:gap-20">
              ...
              <div className="flex-1 w-full relative">
                <div className="aspect-[4/3] rounded-2xl overflow-hidden shadow-2xl border border-gray-100">
                  <img src="https://images.unsplash.com/photo-1628126235206-5260b9ea6441?auto=format&fit=crop&q=80&w=1000" alt="Configuração de Brindes" className="w-full h-full object-cover" />
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row-reverse items-center gap-12 lg:gap-20">
              ...
              <div className="flex-1 w-full relative">
                <div className="aspect-[4/3] rounded-2xl overflow-hidden shadow-2xl border border-gray-100">
                  <img src="https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?auto=format&fit=crop&q=80&w=1000" alt="Link Gerado no Tablet" className="w-full h-full object-cover" />
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row items-center gap-12 lg:gap-20">
              ...
              <div className="flex-1 w-full relative">
                <div className="aspect-[4/3] rounded-2xl overflow-hidden shadow-2xl border border-gray-100">
                  <img src="https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&q=80&w=1000" alt="CRM e Conversão" className="w-full h-full object-cover" />
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto w-full">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-200 flex flex-col h-full hover:shadow-md transition-shadow">
              ...
              <button className="w-full py-3.5 px-6 font-semibold text-blue-600 bg-blue-50 border-2 border-blue-100 rounded-xl hover:bg-blue-100 transition-colors">
                Começar com Starter
              </button>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-[0_8px_30px_rgb(0,0,0,0.08)] border-2 border-blue-600 flex flex-col h-full relative transform md:-translate-y-4">
              ...
              <button className="w-full py-3.5 px-6 font-semibold text-white bg-blue-600 rounded-xl hover:bg-blue-700 transition-all shadow-lg hover:shadow-blue-600/30">
                Assinar Plano Pro
              </button>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-200 flex flex-col h-full hover:shadow-md transition-shadow">
              ...
              <button className="w-full py-3.5 px-6 font-semibold text-gray-900 bg-gray-100 rounded-xl hover:bg-gray-200 transition-colors">
                Falar com Consultor
              </button>
            </div>
          </div>
      ...
      <section className="px-6 py-24 bg-gray-900 text-white">
        <div className="max-w-7xl mx-auto w-full flex flex-col md:flex-row items-center justify-between gap-12">
          <div className="flex-1">
            ...
            <button className="px-8 py-4 font-bold text-gray-900 bg-white rounded-xl hover:bg-gray-100 transition-colors">
